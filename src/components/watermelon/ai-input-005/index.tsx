...
export const AiInput005: React.FC<AiInput005Props> = ({ messages, onSend, isProcessing }) => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-white font-sans text-neutral-900 antialiased dark:bg-[#000000] dark:text-white">
      ...
      <div className="no-scrollbar relative z-10 flex-1 overflow-y-auto px-6">
        <div className="mx-auto w-full max-w-3xl pt-4 pb-40">
          <AnimatePresence initial={false}>
            {messages.map((message) => (
              ...
              >
                <div className="max-w-[85%] rounded-[14px] px-4 py-2 text-[15px] leading-[1.6] bg-neutral-100 font-medium dark:bg-[#121212]">
                  {message.isThinking ? (
                  ...
                  <motion.button
                    ...
                    onClick={() =>
                      setThinkingMode((prev) =>
                        prev === ThinkingMode.DEEP ? ThinkingMode.NORMAL : ThinkingMode.DEEP
                      )
                    }
